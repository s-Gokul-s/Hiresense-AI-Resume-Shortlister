...
MODEL_REPO = "s-Gokul-s/hiresense-model"
...
class PredictionService:
    def __init__(self):
        print(f"Loading model from Hugging Face Hub ({MODEL_REPO}) onto {DEVICE}...")
        self.model = AutoModelForSequenceClassification.from_pretrained(MODEL_REPO).to(DEVICE)
